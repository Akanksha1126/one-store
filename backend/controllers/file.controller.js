...
exports.createFile = async (req, res) => { 
    console.log("Inside the createfile function");
    const fileId = uuid.v4();
    console.log("Now fileID is "+fileId);
    req.fileId = fileId;
    console.log("req.fileId "+req.fileId);
    try {
        // Upload the file
        if(shouldUseS3){
            console.log(shouldUseS3);
            console.log("Uploading a file to S3.");
            await uploadFileToS3(req, res);
            console.log("Right After Uploading a file to S3.");
        }else{
        ...
        File.create({
            ...
            console.log("At the end of createFile function");
